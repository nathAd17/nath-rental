    ...
    button: ({ context, props }) => ({
        class: [
            ...
            // Color
            {
                ...
                'bg-lime border-stroke text-primary-inverse': context.active
            },
            // Invalid State
            { 'border-red-500 dark:border-red-400': props.invalid },

            // States
            'focus:outline-none focus:outline-offset-0 focus:ring focus:ring-stroke dark:focus:ring-strokedark focus:z-10',
            {
                'hover:bg-surface-50 dark:hover:bg-surface-800/80': !context.active && !props.invalid,
                'hover:bg-limehover': context.active
            },
